...
response = openai.ChatCompletion.create(
  model="gpt-3.5-turbo",
  messages=[
    {"role": "system", "content": "you are a helpful assitant that give valueable advice for small merchant"},
    {"role": "user", "content": "I'm a store name noisy electronics from anfu road, shanghai, i want to have some new products to sell, any keywords do you recommend? and what's the price range?"}
  ]
)
